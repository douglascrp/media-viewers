...
<head>
    ...
    <link rel="stylesheet" type="text/css" href='<@checksumResource src="${url.context}/res/extras/modules/PdfJsRaw/viewer.css" />'/>

    <#--<@link rel="stylesheet" type="text/css" href="${url.context}/res/extras/components/preview/PdfJsRaw/viewer.css" />-->
    ...
    <div id="mainContainer">
        ...
        <div id="secondaryToolbar" class="secondaryToolbar hidden doorHangerRight">
            <div id="secondaryToolbarButtonContainer">
                ...
                <button id="secondaryOpenFile" class="secondaryToolbarButton openFile hidden" title="Open File" tabindex="52" data-l10n-id="open_file">
